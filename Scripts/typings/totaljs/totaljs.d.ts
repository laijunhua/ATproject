...
declare module TotalJS {
    ...
    interface SchemaBuilder {
        ...
        add(name: string): SchemaBuilderEntity;
        create(name: string): SchemaBuilderEntity;
        get(name: string): SchemaBuilderEntity;
        remove(name?: string): SchemaBuilderEntity;

    }

    interface SchemaBuilderEntity {
        define(name: string, type: Object, required?: boolean): SchemaBuilderEntity;
        make(model: Object, callback: (err: ErrorBuilder, model: Object) => Object);
        setDefault(fn: (name: string, create: boolean, entityName: string) => void): SchemaBuilderEntity;
        setDefault();
        setValidation(fn: (propertyName: string, value: any, path: string, entityName: string, model: Object) => void, required?: boolean): PerformanceEntry;
        validate(model: Object, resourcePrefix?: string, resourceName?: string): ErrorBuilder;
        prepare(model: Object): Object;
        addCompose(name: string, fn: (error: ErrorBuilder, model: Object, helper: Object, callback: (result: Object) => void, entityName: string) => void);
        addWorkflow(name: string, fn: (error: ErrorBuilder, model: Object, helper: Object, callback: (result: Object) => void, entityName: string) => void);
        setGet(fn: (error: ErrorBuilder, model: Object, helper: Object, callback: (err: ErrorBuilder, result: Object) => void) => void);
        setSave(fn: (error: ErrorBuilder, model: any, helper: Object, callback: (err: ErrorBuilder, result: Object) => void) => void);
        setRemove(fn: (error: ErrorBuilder, model: Object, helper: Object, callback: (err: ErrorBuilder, result: Object) => void) => void);
    }
...
declare module Builders {
    ...
    /**
     * Creates the schema group. The schema supports joining entities in the same group.
     */
    export function schema(name: string, page: number, max: number, format?: string): TotalJS.SchemaBuilder;
...
declare function SCHEMA(name: string): TotalJS.SchemaBuilder;
declare function SCHEMA(name: string, entityName: string): TotalJS.SchemaBuilderEntity;
